...
const Navbar = () => {
  const { user, userData, userRole, handleLogout: contextLogout } = useAppContext();
  ...
  const IconWrapper: React.FC<IconWrapperProps> = ({ src, alt, onClick, className }) => (
    <motion.div 
                ...
                <UserButton.Action
                  ...
                  labelIcon={
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.5 20.118a7.5 7.5 0 0 1 6.941-4.486A3.75 3.75 0 0 1 18 15.75v.231a2.25 2.25 0 0 1-2.25 2.25h-5.5A2.25 2.25 0 0 1 8.25 18v-.231a3.75 3.75 0 0 1 1.559-6.441A7.5 7.5 0 0 1 4.5 20.118Z" />
                    </svg>
                  }
          ...
          >
              ...
              <div className="flex flex-col">
                ...
                <Link 
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className={`w-5 h-5 ${isActive("/services") ? 'text-white' : (theme === 'dark' ? 'text-white' : 'text-gray-800')}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V19.5a2.25 2.25 0 0 0 2.25 2.25h.75m0-3H21" />
                  </svg>
                  <span className={`text-base ${isActive("/services") ? 'text-white' : 'text-text-primary'}`}>Services</span>
                </Link>
                <Link 
                  href="/features" 
                  className={`transition py-3 flex items-center gap-2 px-4 border-b border-border-color ${
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className={`w-5 h-5 ${isActive("/features") ? 'text-white' : (theme === 'dark' ? 'text-white' : 'text-gray-800')}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
                  </svg>
                  <span className={`text-base ${isActive("/features") ? 'text-white' : 'text-text-primary'}`}>Features</span>
                </Link>
                <Link 
                  href="/contact" 
                  className={`transition py-3 flex items-center gap-2 px-4 border-b border-border-color ${
                ...
                {user && (
                  <>
                    ...
                    >
                      ...
                      <span className="text-base text-text-primary">Profile Settings</span>
                    </Link>
                    <button
