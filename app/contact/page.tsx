          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-secondary max-w-3xl mx-auto">
                Ready to get started? Contact us today to learn more about how
                Eman Clinic can transform your healthcare facility.
              </p>
            </div>
          </div>
        </section>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="mt-2 text-sm text-green-600">
                            We'll get back to you within 24-48 hours. Thank you
                            for your feedback!
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-blue-700 mb-4">
                        ...
                        Your message has been received and will be reviewed by
                        our team.
                      </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-text-secondary max-w-2xl mx-auto">
                Find answers to common questions about Eman Clinic and our
                healthcare services.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg">
                ...
                <CardContent>
                  <p className="text-text-secondary">
                    ...
                    general consultations, laboratory testing, pharmacy
                    services, and specialized medical treatments. Our team of
                    experienced healthcare professionals is here to serve your
                    needs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg">
                ...
                <CardContent>
                  <p className="text-text-secondary">
                    You can schedule appointments through our online booking
                    system, by calling us directly, or visiting our clinic. We
              ...
              <Card className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg">
                ...
                <CardContent>
                  <p className="text-text-secondary">
                    Yes, we accept most major insurance plans and also offer
                    affordable self-pay options. Our billing team will work with
                    you to ensure you understand your coverage and out-of-pocket
              ...
              <Card className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg">
                ...
                <CardContent>
                  <p className="text-text-secondary">
                    ...
                    Saturday from 9:00 AM to 5:00 PM, and Sunday from 10:00 AM
                    to 4:00 PM. Emergency services are available 24/7 through
                    our on-call system.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg">
                ...
                <CardContent>
                  <p className="text-text-secondary">
                    ...
                    patient portal. Simply log in with your credentials to view
                    test results, appointment history, and medical documents. We
                    also provide paper copies upon request.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg">
                ...
                <CardContent>
                  <p className="text-text-secondary">
                    While we're not a full emergency room, we do provide urgent
                    care services for non-life-threatening conditions. For true
        ...
        <section className="py-20 bg-blue-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of healthcare providers who trust Eman Clinic to
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/sign-up">
                <Button
                  size="lg"
                  className="text-lg px-8 py-3 text-white shadow-lg cursor-pointer bg-[#1447E6] hover:bg-gray-700"
                >
                  Start Free Trial
                </Button>
              </Link>
