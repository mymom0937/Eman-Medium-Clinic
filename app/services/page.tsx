  ...
  const services = [
    {
      ...
      description:
        "Manage your clinic's medication stock with automatic alerts for low stock and expiring medications.",
      features: [
    ...
    },
    {
      ...
      description:
        "Store and access patient information, medical history, and treatment records in one place.",
      features: [
    ...
    },
    {
      ...
      description:
        "Record and track patient consultations, diagnoses, and treatment plans with detailed notes.",
      features: [
    ...
    },
    {
      ...
      description:
        "Manage and track patient lab tests, results, and medical reports in organized files.",
      features: [
        "Lab test orders",
        "Results storage",
        "Report management",
    ...
    },
    {
      ...
      description:
        "Create, track, and manage patient prescriptions with dosage instructions and refill alerts.",
      features: [
    ...
    },
    {
      ...
      description:
        "Schedule and track patient follow-ups, check-ups, and preventive care appointments.",
      features: [
        "Follow-up scheduling",
        "Preventive care",
        "Health reminders",
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 bg-background text-text-primary transition-colors duration-200 pt-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            Simple, efficient healthcare management solutions designed for
            medium-sized clinics to improve patient care and streamline
            operations.
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="hover:shadow-lg transition-shadow border border-border-color bg-card-bg"
              >
        ...
        <div className="text-center bg-blue-600 p-12 rounded-xl">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-white/90">
            Join other clinics who trust Eman Clinic to manage their operations
            efficiently.
          </p>
