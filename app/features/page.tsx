...
export default function FeaturesPage() {
  const features = [
    {
      ...
      description:
        "Track drug stock levels, expiry dates, and manage inventory efficiently.",
      details: [
    ...
    },
    {
      ...
      description:
        "Maintain comprehensive patient information and medical history.",
      details: [
    ...
    },
    {
      ...
      title: "Notifications",
      description:
        "Stay updated with alerts for low stock, appointments, and more.",
      details: [
        "Real-time alerts",
        "Email notifications",
        "SMS reminders",
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Enhanced patient management leads to improved healthcare outcomes",
      icon: "❤️",
    },
    {
      title: "Cost Savings",
    ...
    },
    {
      title: "Data Security",
      description:
        "HIPAA-compliant security measures protect sensitive information",
      icon: "🔒",
    },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-secondary max-w-3xl mx-auto">
                Everything you need to run your clinic efficiently, from
                inventory management to patient care and financial tracking.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className="hover:shadow-lg transition-shadow border border-border-color bg-background"
                >
                  <CardHeader>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-text-secondary max-w-2xl mx-auto">
                Discover the benefits that make our platform the preferred
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {benefits.map((benefit, index) => (
                <Card
                  key={index}
                  className="text-center hover:shadow-lg transition-shadow border border-border-color bg-card-bg"
                >
                  <CardHeader>
        ...
        <section className="py-20 bg-card-bg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-text-secondary max-w-2xl mx-auto">
                Connect with your existing systems and tools for a unified
                workflow.
              </p>
            </div>
        ...
        <section className="py-20 bg-blue-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Start your free trial today and see how Eman Clinic can transform
